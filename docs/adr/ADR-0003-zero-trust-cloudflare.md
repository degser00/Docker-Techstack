...
|----------|------------|---------|------|--------------------|--------|
| LLM (Open WebUI) | `llm.example.com` | `llm-ui-tunnel` | `*` | ✅ Enabled | Ready |
| n8n | `n8n.example.com` | `n8n-ui-tunnel` | `*` | ✅ Enabled | Ready |
| Observability stack | `obs.example.com` | `observability-ui-tunnel` | `*` | ✅ Enabled | N/A |
| n8n Webhooks | `hooks.example.com` | `n8n-webhook-tunnel` | `/webhook/*` | 🚫 Disabled (public) | Ready |
