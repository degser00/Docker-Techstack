...
| Service | Subdomain | Tunnel | Cloudflare Access |
|----------|------------|---------|--------------------|
| LLM (Open WebUI) | `llm.example.com` | `llm-ui-tunnel` | ✅ Enabled |
| n8n | `n8n.example.com` | `n8n-ui-tunnel` | ✅ Enabled |
| Observability stack | `obs.example.com` | `observability-ui-tunnel` | ✅ Enabled |
| n8n Webhooks | `hooks.example.com` | `n8n-webhook-tunnel` | 🚫 Disabled (public) |
